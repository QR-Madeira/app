<div class='grid grid-cols-6 p-4 border-2 rounded border-black w-full h-36'>
  ...
  <h1 class='text-3xl'>{{$attraction->title}}</h1>
  <h1 class='text-lg max-h-28'>{{$attraction->description}}</h1>
  <h1 class='text-lg max-h-28'>Created by: {{$attraction->creator_name}}</h1>
  <h1 class='text-lg max-h-28'>Created at: {{$attraction->created_at_}}</h1>

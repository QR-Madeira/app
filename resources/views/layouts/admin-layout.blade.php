  ...
  <div class="fixed top-0 left-0 w-64 h-screen">
    <div class="h-full px-3 py-4 overflow-y-auto bg-slate-500 flex flex-col">
      <div class="w-auto h-auto rounded-lg bg-slate-700 items-center text-left mb-4 p-2">
        <p class="ml-2 mr-2 w-auto h-auto break-all text-white">Admin123</p>
      </div>
       <ul class="space-y-2 font-medium flex flex-col justify-between h-full">
        <div class="space-y-2">
          <li>
              <a href="{{route('admin.list_users')}}" class="flex items-center p-2 text-white rounded-lg hover:bg-slate-600">
          ...
          <li>
              <a href="#" class="flex items-center p-2 text-white rounded-lg hover:bg-slate-600">

    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-slate-500 flex flex-col">
      <div class="w-auto h-auto rounded-lg bg-slate-700 items-center text-left mb-4 p-2">
       ...
       <ul class="space-y-2 font-medium flex flex-col justify-between h-full">
        <div class="space-y-2">
          <li>
              <a href="{{route('admin.list_users')}}" class="flex items-center p-2 text-white rounded-lg @if(Session::get('place') == 'admin_usr') bg-slate-600 @endif hover:bg-slate-600">
          ...
          <li>
              <a href="{{route('admin.list')}}" class="flex items-center p-2 text-white rounded-lg @if(Session::get('place') == 'admin_attr') bg-slate-600 @endif hover:bg-slate-600">
